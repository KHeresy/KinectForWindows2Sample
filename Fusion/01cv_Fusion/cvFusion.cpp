...
int main(int argc, char** argv)
{
	...
	mResolution.voxelsPerMeter = 256;
	mResolution.voxelCountX = 512;
	mResolution.voxelCountY = 512;
	mResolution.voxelCountZ = 512;
	...
	if (NuiFusionCreateReconstruction(&mResolution, NUI_FUSION_RECONSTRUCTION_PROCESSOR_TYPE_AMP, -1, &worldToCameraTransform, &pReconstruction) != S_OK)
	{
